...
class MovimentacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movimentacao" do
    assert_difference('Movimentacao.count') do
      post movimentacaos_url, params: { movimentacao: { data: @movimentacao.data, local_armazenamento_id: @movimentacao.local_armazenamento_id, produto_id: @movimentacao.produto_id, quantidade: @movimentacao.quantidade, tipo: @movimentacao.tipo } }
    end
  ...
  test "should update movimentacao" do
    patch movimentacao_url(@movimentacao), params: { movimentacao: { data: @movimentacao.data, local_armazenamento_id: @movimentacao.local_armazenamento_id, produto_id: @movimentacao.produto_id, quantidade: @movimentacao.quantidade, tipo: @movimentacao.tipo } }
